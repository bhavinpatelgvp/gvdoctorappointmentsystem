    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(choices=[('admin', 'Administrator'), ('doctor', 'Doctor'), ('student', 'Student'), ('staff', 'Staff'), ('staff_family', 'Staff Family Member'), ('hod', 'HOD'), ('super_admin', 'Super Administrator')], max_length=20, unique=True)),
